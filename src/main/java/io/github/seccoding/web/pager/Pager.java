...
public abstract class Pager {
	...
	protected int printArticle;	// 보여줄 게시글 수
	public int printPage;		// 보여줄 페이지 
	...
	public int nextGroupPageNumber;	// 다음 페이지 그룹의 첫번째 페이지 번
	public int prevGroupPageNumber;  // 이
...
//	Oracle 과 나머지가 방법이 다르다. 
	...
	public void setTotalArticleCount(int count) {
		...
		this.totalPage = (int) Math.ceil((double) this.totalArticleCount	// Math.ceil : 올림함수
				/ this.printArticle);
